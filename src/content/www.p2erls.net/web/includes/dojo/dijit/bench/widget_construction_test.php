...
?>
<?php generateChaff($leadingChaff); ?>
<hr>
<?php for($i=0;$i<$containerDepth;$i++){ ?>
...
<?php for($i=0;$i<$items;$i++){ ?>
			<div dojoType="<?php= $widgetName ?>" label="item2 <?php= $i ?>">item2 <?php= $i ?></div>
<?php } ?>
<?php for($i=0;$i<$containerDepth;$i++){ ?>
			</td>
		</tr>
...
<?php } ?>
<?php generateChaff($trailingChaff);  ?>
<?php for($i=0;$i<$items;$i++){ ?>
	<div dojoType="<?php= $widgetName ?>" label="item2 <?php= $i ?>"><span>item <?php= $i ?></span></div>
<?php } ?>
