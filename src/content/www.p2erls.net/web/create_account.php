      ...
      <form onSubmit="return validate_registration(this)" action="process_create_account.php" method="post">
                  ...
                  <table width="544" border="0" align="center" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
					  ...
					  <i><font color="#666666" size="2">Please type in the letters you see in the above image. If you are having trouble with the current image please refresh this page.</font></i></p>
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
