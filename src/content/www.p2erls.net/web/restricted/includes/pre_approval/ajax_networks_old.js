...
/*
	...
	Param = url >> Url to call : network_id = Passing div network_id for multiple use ~ as a seprator for eg. div1~div2 :
...
/*
	...
	Desc = This function is used to valnetwork_idation for the empty field 
...
function init_table() {
	...
	function save_data() {
		...
		if(checkValidation==true) {
			requestInfo('showNetworks.php?mode=save_new&network_id='+network_id+'&network_name='+network_name+'&network_url='+network_url,'showNetworks','');
		} 
	}
	...
	function update_data() {
		...
		if(checkValidation==true) {
			requestInfo('showNetworks.php?mode=update_data&network_id='+network_id+'&network_name='+network_name+'&network_url='+network_url+'&prev_network_id='+prev_network_id,'showNetworks','');
		} 
	}
