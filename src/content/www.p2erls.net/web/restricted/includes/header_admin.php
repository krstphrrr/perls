<tr>
	<td height="25" align="right">Welcome User: <?php echo "<b>$_SESSION[p2erls_username]</b>&nbsp;&nbsp;"; if ($_SESSION["p2erls_access_level"] == 1){ ?> <a href="accounts.php">Accounts</a> || <a href="approvals.php">Approvals</a> || <?php } ?><a href="https://www.p2erls.net/p2erls/">Main Site</a> || <a href="Security_Dept/logout.php">Log Out</a>&nbsp;</td>
</tr>
<tr>
