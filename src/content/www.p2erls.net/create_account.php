...
<script type="text/javascript" language="javascript" src="web/p2erls/restricted/includes/ajax_login.js"></script>
...
<body>
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0"><? include("includes/login.php"); ?>
  <tr>
      ...
      <form onSubmit="return validate_registration(this)" action="process_create_account.php" method="post">
                  ...
                  <table width="544" border="0" align="center" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
						...
						?>
						<option value="<? echo"$state_id"; ?>"><? echo"$state_name"; ?></option>
						<? } ?>
						</select>
						</td>
                    </tr>
