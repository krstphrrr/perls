		...
		// Display all the data from the table
			...
			for ($i_links = 0; $i_links < $num_results_links; $i_links++) 
			{
				...
				$link_url	= mysql_result($result_links,$i_links,"link_url");
				 ?>
              <tr align="left" valign="top">
                <td><a href="<? echo "$link_url"; ?>" target="_blank" class="header_small"><? echo "$link_name"; ?> &raquo;</a></td>
              </tr>
              <? } ?>
          </table>
		  <br />
		...
		// Display all the data from the table
			...
			for ($i_links = 0; $i_links < $num_results_links; $i_links++) 
			{
				...
				$link_url	= mysql_result($result_links,$i_links,"link_url");
				 ?>
              <tr align="left" valign="top">
                <td><a href="<? echo "$link_url"; ?>" target="_blank" class="white_small"><? echo "$link_name"; ?> &raquo;</a></td>
              </tr>
              <? } ?>
			  <tr>
			  	<td>
          ...
          <td width="713" valign="top"><h2 align="center">Welcome to the Pole-to-Pole Ecological Research Lattice of Sites (P<sup>2</sup>ERLS)!</h2>
              <div align="justify" style="padding-right:20px;">
                ...
                <div><a name="how"></a><span class="section">How to use this site</span>
                    <p><a href="browse_sites.php"><img src="images/mapshoted.png" width="350" height="275" border="0" align="left" alt="Click on the map or Browse Sites link to search for sites" style="margin-right:10px;" /></a>This website will allow you to search for one or more sites by several different criteria, and by two different methods.</p>
