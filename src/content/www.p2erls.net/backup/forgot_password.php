  ...
  <tr>
	...
	<table width="988" border="0" cellspacing="0" cellpadding="5">
        <tr align="left" valign="top">
          <td width="250">&nbsp;</td>
		  <td width="718" style="padding-right:20px;padding-top:10px;padding-bottom:10px;">
			<div id="loginDetails">
		      <h3><span class="purple">Forgot Password </span></h3>
		      <p class="purple">Please enter your email address and we will send you your <span class="orange">password</span>. <br />
              </p>
		      <form onsubmit="return validate_forgot_password(this)" action="process_forgot_password.php" method="post" >
                <table width="318" border="0" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td width="69">Email:</td>
                    <td width="229"><input name="email" type="text" id="email" size="25" /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
