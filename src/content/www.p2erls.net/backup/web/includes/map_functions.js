...
var site_name = [];var site_url = [];var site_lat = [];var site_long = [];var site_elevlow = [];var site_elevhigh = [];var site_elevmean = [];var site_temp = [];var site_precip = [];var site_desc = [];var ecosystem_id = [];var site_id = [];var country_id = [];
...
function mapReset() { map.setCenter(new GLatLng(32.311740, -106.782026), 3 ,G_HYBRID_TYPE);  }
...
{ 
	if (GBrowserIsCompatible()) 
	{
		...
		map.setCenter(new GLatLng(32.311740, -106.782026), 3 );
		map.setMapType(G_HYBRID_TYPE);  
		map.addControl(new GOverviewMapControl());
		map.addControl(new GScaleControl());
		
		var blueIcon = new GIcon(G_DEFAULT_ICON);
  		blueIcon.image = "http://www.p2erls.net/web/images/marker.png";
		...
		for (zz = 0; zz < markers.length; zz++) 
			{
				...
				MyMarkers[current_id] = createMarker(point[current_id], site_name[current_id], site_url[current_id], current_id, markerOptions);
...
function createMarker(point, site_name, site_url, site_id, markerOptions) 
{
  	var marker = new GMarker(point, markerOptions);
  	var html = "<b>" + site_name + "</b><br/><br/><a href='site.php?site_id=" + site_id + "' target='_blank'>More &raquo;</a><br/><a href='" + site_url + "' target='_blank'>View Website &raquo;</a>";
	...
	GEvent.addListener(marker, 'click', function() 
	{
  	...
  	// Switch icon on marker mouseover and mouseout
        GEvent.addListener(marker, "mouseover", function() {
          marker.setImage("http://www.p2erls.net/web/images/coldmarker.png");
        });
        GEvent.addListener(marker, "mouseout", function() {
          marker.setImage("http://www.p2erls.net/web/images/marker.png");
        });
	return marker;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{ 
	...
	{		
		...
		var site_elevlow_min=document.getElementById("site_elevlow_min").value;
		var site_elevlow_max=document.getElementById("site_elevlow_max").value;
		var site_elevhigh_min=document.getElementById("site_elevhigh_min").value;
		var site_elevhigh_max=document.getElementById("site_elevhigh_max").value;
	...
	{		
		...
		var site_elevlow_min = "";
		var site_elevlow_max = "";
		var site_elevhigh_min = "";
		var site_elevhigh_max = "";
		var site_temp_min = "";
		var site_temp_max = ""; 
		var site_precip_min = "";
		var site_precip_max = "";  
	...
	if(search_type!='Sites')// the following are the default search criteria
	{
		...
		url=url+"&site_elevlow_min="+site_elevlow_min
		url=url+"&site_elevlow_max="+site_elevlow_max
		url=url+"&site_elevhigh_min="+site_elevhigh_min
		url=url+"&site_elevhigh_max="+site_elevhigh_max
	...
	xmlHttp.onreadystatechange = function(){if(xmlHttp.readyState == 4)
	{
		...
		searchSiteCriteriaTable(search_type,select_multiple_programs,select_multiple_networks,select_multiple_gradients,select_multiple_regions,select_multiple_ecosystems,site_elevlow_min,site_elevlow_max,site_elevhigh_min,site_elevhigh_max,site_temp_min,site_temp_max,site_precip_min,site_precip_max);
...
function searchSiteCriteriaTable(search_type,select_multiple_programs,select_multiple_networks,select_multiple_gradients,select_multiple_regions,select_multiple_ecosystems,site_elevlow_min,site_elevlow_max,site_elevhigh_min,site_elevhigh_max,site_temp_min,site_temp_max,site_precip_min,site_precip_max)
{ 
	...
	if(search_type!='Sites')// the following are the default search criteria
	{
		...
		url2=url2+"&site_elevlow_min="+site_elevlow_min
		url2=url2+"&site_elevlow_max="+site_elevlow_max
		url2=url2+"&site_elevhigh_min="+site_elevhigh_min
		url2=url2+"&site_elevhigh_max="+site_elevhigh_max
...
{  
	...
	var search_name = prompt('Please enter the name of your Search. \n\n', '');
...
function loadSearch(select_multiple_programs,select_multiple_networks,select_multiple_gradients,select_multiple_regions,select_multiple_ecosystems,site_elevlow_min,site_elevlow_max,site_elevhigh_min,site_elevhigh_max,site_temp_min,site_temp_max,site_precip_min,site_precip_max)
{  
/*
	...
	document.getElementById("site_elevlow_min").value 			= site_elevlow_min;
	document.getElementById("site_elevlow_max").value 			= site_elevlow_max;
	document.getElementById("site_elevhigh_min").value 			= site_elevhigh_min;
	document.getElementById("site_elevhigh_max").value 			= site_elevhigh_max;
...
*/	
	...
	xmlHttp.onreadystatechange = function(){if(xmlHttp.readyState == 4)
	{
		search_sites_criteria = xmlHttp.responseText; 
		addNew(search_sites_criteria);
		searchSiteCriteriaTable('Saved',select_multiple_programs,select_multiple_networks,select_multiple_gradients,select_multiple_regions,select_multiple_ecosystems,site_elevlow_min,site_elevlow_max,site_elevhigh_min,site_elevhigh_max,site_temp_min,site_temp_max,site_precip_min,site_precip_max);
		document.getElementById('loadingMarkers').innerHTML = "";
	}}   
