...
//<![CDATA[ 
	...
	var xmlHttp2; 
	var xmlHttp3;	
	var current_sites_queried; 
	var search_sites_criteria; 
	var search_type;

var site_name = [];var site_url = [];var site_lat = [];var site_long = [];var site_elevlow = [];var site_elevhigh = [];var site_elevmean = [];var site_temp = [];var site_precip = [];var site_desc = [];var ecosystem_id = [];var site_id = [];var country_id = [];var site_flyer = []; var site_length;
...
{ 
	if (GBrowserIsCompatible()) 
	{
		...
		var blueIcon = new GIcon(G_DEFAULT_ICON);
  		blueIcon.image = "/images/marker_beige.png";
		//alert("i m working 1");
...
{
	if(site_flyer != ''){ var pdfhtml = "<br/> <a href='www/www.p2erls.net/flyers/" + site_id + "/" + site_flyer + "' target='_blank'>Site Pdf &raquo;</a>";} else { pdfhtml = '';}
	...
	GEvent.addListener(marker, 'click', function() 
	{
  	...
  	// Switch icon on marker mouseover and mouseout
        GEvent.addListener(marker, "mouseover", function() {
          marker.setImage("www/www.p2erls.net/images/marker_white.png");
        });
        GEvent.addListener(marker, "mouseout", function() {
          marker.setImage("www/www.p2erls.net/images/marker_beige.png");
        });
	return marker;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{ 
	...
	{		
		...
		var site_length=document.getElementById("site_length").value;
	}
	...
	xmlHttp.onreadystatechange = function()
	{
		if(xmlHttp.readyState == 4)
		{
			...
			if (search_results != '')
			{
				...
				{
					searchSiteCriteriaTable(search_type,search_results,select_multiple_programs,select_multiple_networks,select_multiple_gradients,select_multiple_regions,select_multiple_ecosystems,site_elev_min,site_elev_max,site_temp_min,site_temp_max,site_precip_min,site_precip_max, site_length);
				}
				else
				{
					searchSiteCriteriaTable(search_type,'',select_multiple_programs,select_multiple_networks,select_multiple_gradients,select_multiple_regions,select_multiple_ecosystems,site_elev_min,site_elev_max,site_temp_min,site_temp_max,site_precip_min,site_precip_max, site_length);
				}
...
function searchSiteCriteriaTable(search_type,search_results,select_multiple_programs,select_multiple_networks,select_multiple_gradients,select_multiple_regions,select_multiple_ecosystems,site_elev_min,site_elev_max,site_temp_min,site_temp_max,site_precip_min,site_precip_max, site_length)
{ 
	//prompt ("",search_type);
	//prompt ("",search_results);
	if(search_type=='Sites')//only for the sites.php page
	...
	else// the following are the default search criteria
	{
		...
		url2=url2+"&site_length="+site_length
	}  
	//prompt("",url2);
	// Run Ajax
	xmlHttp.onreadystatechange = function()
...
*/	
	...
	url=url+"&search_type=Main" 
		...
		url=url+"&site_precip_min="+site_precip_min 
		url=url+"&site_precip_max="+site_precip_max 
		url=url+"&site_length="+site_length 
