...
{ 
	if (GBrowserIsCompatible()) 
	{
		...
		var blueIcon = new GIcon(G_DEFAULT_ICON);
  		blueIcon.image = "http://www.digitalsolutionslc.com/web/p2erls/images/marker_beige.png";
...
{
	if(site_flyer != ''){ var pdfhtml = "<br/> <a href='http://www.digitalsolutionslc.com/web/p2erls/flyers/" + site_id + "/" + site_flyer + "' target='_blank'>Site Pdf &raquo;</a>";} else { pdfhtml = '';}
	...
	GEvent.addListener(marker, 'click', function() 
	{
  	...
  	// Switch icon on marker mouseover and mouseout
        GEvent.addListener(marker, "mouseover", function() {
          marker.setImage("http://www.digitalsolutionslc.com/web/p2erls/images/marker_white.png");
        });
        GEvent.addListener(marker, "mouseout", function() {
          marker.setImage("http://www.digitalsolutionslc.com/web/p2erls/images/marker_beige.png");
        });
	return marker;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
