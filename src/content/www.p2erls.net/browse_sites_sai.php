...
<script type="text/javascript" language="javascript"  src="https://maps.google.com/maps?file=api&v=2&key=ABQIAAAASnpDFqD4bcXj7kSd5IwZJxRBJaH5kVAE2FIAMXg-zOHkL3oC4RRW82i7w-_PrOPd-JZIfuDcMy0aEA" type="text/javascript"></script>
			...
			<tr align="left" valign="top">
				...
				<table width="223" align="center" border="0" cellspacing="0" cellpadding="6">
					...
					<tr align="center">
						...
						<?php
						$query_sites = "SELECT * FROM p2erls_sites WHERE pending_change = 'No' "; 
						$result_ecosystems1 = mysql_query($query_sites);
						$num_results_ecosystems1 = mysql_num_rows($result_sites);
						?>
						...
						<table width="100%" border="0" cellpadding="2" cellspacing="0">
                          		<tr>
                            		<td width="14%" class="header_small"><span class="header_medium"><a href="about.php#glossary" target="_blank"><img src="images/help.gif" width="25" height="26" border="0" /></a></span></td>
                            		<td width="86%" class="header_small">
									<select id="select_multiple_lat" style="width: 130px;" name="latt">
								
                  				<?php
								for ($kk_lat=0; $kk_lat <$num_results_ecosystems1; $kk_lat++)
								{
									$site_lat= mysql_result($result_ecosystems1,$kk_lat,"site_lat");									
								?>
                  				<option value="<?php echo $site_lat;?>"><?php echo $site_lat;?></option>
                  				<?php } ?>
							</select>							
							<a href="" class="white_small" id="select_multiple_programs_open">Multiple</a></td>
                          </tr>
						...
						<table width="100%" border="0" cellpadding="2" cellspacing="0">
                          		<tr>
                            		<td width="14%" class="header_small"><span class="header_medium"><a href="about.php#glossary" target="_blank"><img src="images/help.gif" width="25" height="26" border="0" /></a></span></td>
                            		<td width="86%" class="header_small">
									<select id="select_multiple_lon" style="width: 130px;" name="long">
								
                  				<?php
								for ($kk_lon=0; $kk_lon <$num_results_ecosystems1; $kk_lon++)
								{
									$site_lon= mysql_result($result_ecosystems1,$kk_lon,"site_long");	
								?>
                  				<option value="<?php echo $site_lon;?>"><?php echo $site_lon;?></option>
                  				<?php } ?>
							</select>							
							<a href="" class="white_small" id="select_multiple_programs_open">Multiple</a></td>
                          </tr>
...
<script type="text/javascript">
    function initialize() {
        ...
        var latSpan = northEast.lat() - southWest.lat();
          for ( i=0; i<document.x.latt.length; i++){		
			var x = document.x.latt.options[i].value;
			var y = document.x.long.options[i].value;
